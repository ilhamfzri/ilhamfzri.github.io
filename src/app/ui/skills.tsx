...
const features: SkillSet[] = [
    {
        name: 'Languages',
        description:
            'Python (FastAPI, Flask, ML Frameworks & Tools), Golang (Gin, GORM, gRPC), and Java (Android Native)',
    ...
    },
    {
        name: 'Technologies',
        description:
            'Virtualization(Docker), Cloud Platform(AWS), Message Broker (RabbitMQ), and CI/CD (Github/Gitlab, Jenkins)',
...
function SkillItem({ skillSet }: { skillSet: SkillSet }) {
    return <div key={skillSet.name} className="relative px-5 py-5 font-semibold rounded-xl border border-solid border-black/[.08] dark:border-white/[.145] transition-colors hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent cursor-pointer">
        <div className="flex">
